...
if my_page == "About the Project":
    ...
    'View Selection', ['-- Please Select View --', 'One Barangay Only', 'Clusters', 'All Barangays'])
...
#                 heatmap_merged_data = pd.DataFrame()
                ...
                heatmap_merged_data = pd.merge(shapefile, heatmap_cluster_df, how='left')
...
#                 fig = go.Figure(data=go.Choropleth(locations=heatmap_merged_data.index,
#                                                    z=heatmap_merged_data[option1a],
#                                                    geojson=json.dumps(heatmap_merged_data.geometry),
#                                                    colorscale="Oranges"))
